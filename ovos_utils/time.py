...
from ovos_utils.location import Hemisphere
...
def get_date_ordinal(ordinal,
    ...
    Example:
        ...
        >>> get_date_ordinal(1, ref_date=datetime(2020, 1, 1), resolution=DateTimeResolution.DAY_OF_WEEK)
        datetime.datetime(2020, 1, 5, 0, 0)

    Args:
        ordinal (int): The ordinal day of the month or week to get the date for.
        offset (int, optional): The reference day of the month or week to use
                                 as a starting point. Defaults to None.
    ...
    # second day of last week
        ...
        return start + timedelta(days=ordinal-1)        
